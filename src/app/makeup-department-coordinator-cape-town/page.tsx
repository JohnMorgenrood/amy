...
export const metadata: Metadata = {
  ...
  description: 'Cape Town makeup department coordination and production support from Amy Morgenrood. Scheduling, continuity, artist requirements, kits, paperwork and on-set makeup and hair support.',
  ...
  openGraph: { title: 'Makeup Department Coordination & Production Support Cape Town', description: 'Coordination, continuity, scheduling and practical makeup department support for Cape Town film and television productions.', url: pageUrl, images: [{ url: 'https://www.amymup.shop/og-image-logo.jpg', width: 1200, height: 630, alt: 'Amy MUP' }] },
}
...
export default function MakeupCoordinatorPage() {
  const schema = {
    ...
    serviceType: 'Makeup and hair department coordination support',
    ...
    <main className="min-h-screen bg-dark-950 pb-24 pt-28 text-cream-100">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <section className="py-16">
          ...
          <p className="mt-7 max-w-3xl text-lg font-light leading-relaxed text-cream-300/75">Alongside my work as a makeup and hair artist, I have gained experience assisting with the coordination, organisation and day-to-day management of makeup departments on film and television productions.</p>
        ...
        <section className="mt-16 text-center"><h2 className="font-display text-4xl font-light">Available for Cape Town productions</h2><p className="mx-auto mt-5 max-w-3xl font-light leading-relaxed text-cream-300/70">I am available for makeup artist, hair artist, assistant, standby and department-support positions, as well as junior or assisting coordination roles.</p><Link href="/#contact" className="btn-primary mt-8 inline-flex items-center gap-2 rounded-full px-7 py-3">Enquire about availability <ArrowRight className="h-4 w-4" /></Link></section>
      </div>
    </main>
  </>
}
